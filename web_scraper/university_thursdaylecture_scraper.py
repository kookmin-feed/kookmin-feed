...
class UniversityThursdaylectureScraper(WebScraper):
    """목요특강 스크래퍼"""

    def __init__(self, url: str):
        super().__init__(url, ScraperType.UNIVERSITY_THURSDAYLECTURE)
    ...
    async def parse_notice_from_element(self, element) -> NoticeData:
        ...
        try:
            ...
            if "global.write(" in onclick:
                ...
                link = f"https://www.kookmin.ac.kr/user/kmuNews/specBbs/thursdayLecture/view.do?dataSeq={post_id}"
            else:
                link = self.url
